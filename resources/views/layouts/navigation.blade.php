            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('agenda.mexico')" >
                                {{ __('México') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('agenda.jamaica')">
                                {{ __('Jamaica') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('agenda.dominicana')">
                                {{ __('Republica Dominicana') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('agenda.españa')">
                                {{ __('España') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
